...
module.exports = {
  ...
  async execute(msg, args, client) {
    ...
    if (!msg.member.hasPermission("BAN_MEMBERS")) return msg.channel.send(noPerms)
    ...
    const specUser = new Discord.MessageEmbed()
      ...
      .setDescription("To ban a member you need to mention the user")
      .addFields(
          {
              name: "Command:",
              value: "~ban [user] reason",
    ...
    const notBanned = new Discord.MessageEmbed()
      ...
      .setDescription(`Sorry, but i cant help you because I don't have perms to ban users\nPlease contact Craftpaly developers to help me `)
      .addFields(
        {
            name: "Command:",
            value: "~ban [user] reason",
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setDescription(`If you think that we have mistakenly banned you out of our server\nPlease do let us know in by going to our website.`)
      .addFields(
        {
          name: "**Reason** :",
          value: `${reason}`,
    ...
    const banned = new Discord.MessageEmbed()
      ...
      .setDescription(`Successfully banned: ${mentionMember.user.tag}`)
     .addFields(
      {
        name: "**Reason** :",
        value: `${reason}`,
    ...
    }).then(() => msg.channel.send(banned)) + console.log( "[" + green("Craft") + gray("Play")+ "]" + greenBright(`${mentionMember.user.tag} got banned by ${msg.author.tag} !`));
    const staffCloseed = new Discord.MessageEmbed()     
                .setColor("#a0e43f")
                .setTitle("Staff banned a member!")
                .setDescription(`${msg.author} banned ${mentionMember.user.tag}`)
                .addFields(
                    {
                        name: "Reason:",
                        value: `${reason}`,
